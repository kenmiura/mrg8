/*
 * cuRAND-XORWOW Random Generator - GPU
 *
...
int main(int argc, char **argv)
{
    ...
    for (i = 0; i < ITER; ++i) {
        ...
        curandCreateGenerator(&prngGPU, CURAND_RNG_PSEUDO_XORWOW);
    ...
    cout << "cuRAND_XORWOW: " << mrng << " [million rng/sec], " << ave_msec << " [milli seconds]" << endl;
    printf("EVALUATION, cuRAND_XORWOW, , , %d, %f, %f\n", N, mrng, ave_msec);
