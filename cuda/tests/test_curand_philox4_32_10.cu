/*
 * cuRAND-PHILOX4_32_10 Random Generator - GPU
 *
...
int main(int argc, char **argv)
{
    ...
    for (i = 0; i < ITER; ++i) {
        ...
        curandCreateGenerator(&prngGPU, CURAND_RNG_PSEUDO_PHILOX4_32_10);
    ...
    cout << "cuRAND_PHILOX4_32_10: " << mrng << " [million rng/sec], " << ave_msec << " [milli seconds]" << endl;
    printf("EVALUATION, cuRAND_PHILOX4_32_10, , , %d, %f, %f\n", N, mrng, ave_msec);
