/*
 * MRG8 Sequential Random Generator ver.2 Thread Parallel
 *
...
int main(int argc, char **argv)
{
    ...
    cout << "MRG8_2_TP: " << mrng << " [million rng/sec], " << ave_msec << " [milli seconds]" << endl;
    printf("EVALUATION, MRG8_2_TP, %d, %d, %f, %f\n", tnum, N, mrng, ave_msec);
